...
import com.vsphone.activities.main.settings.SettingListener
import com.vsphone.activities.voip.data.ConferenceParticipantDeviceData
import com.vsphone.activities.voip.views.ScrollDotsView
import com.vsphone.contact.ContactAvatarGenerator
import com.vsphone.contact.ContactDataInterface
import com.vsphone.contact.getPictureUri
import com.vsphone.views.VoiceRecordProgressBar
    ...
    if (contact == null) {
        ...
        imageView.load(
            AppCompatResources.getDrawable(
                context,
                R.drawable.icon_multiple_contacts_avatar
            )
        )
    } else {
