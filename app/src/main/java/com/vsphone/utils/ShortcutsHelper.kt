                    ...
                    if (!processedAddresses.contains(stringAddress)) {
                        ...
                        if (contact != null && contact.refKey != null) {
                            val shortcut: ShortcutInfoCompat? =
                                createContactShortcut(context, contact)
                            if (shortcut != null) {
        ...
        private fun createChatRoomShortcut(
            ...
            try {
                ...
                if (chatRoom.hasCapability(ChatRoomCapabilities.Basic.toInt())) {
                    ...
                    subject = contact?.name ?: VSPhoneUtils.getDisplayName(chatRoom.peerAddress)
                    ...
                    subject = contact?.name ?: VSPhoneUtils.getDisplayName(address)
                    icon = person?.icon ?: coreContext.contactsManager.contactAvatar
                } else {
