...
import com.vsphone.activities.assistant.viewmodels.RemoteProvisioningViewModel
...
class RemoteProvisioningFragment : GenericFragment<AssistantRemoteProvisioningFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.urlToFetch.value =
            sharedAssistantViewModel.remoteProvisioningUrl.value ?: coreContext.core.provisioningUri
    }
