...
import com.vsphone.activities.assistant.viewmodels.PhoneAccountLinkingViewModelFactory
...
class PhoneAccountLinkingFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(
            this,
            PhoneAccountLinkingViewModelFactory(accountCreator)
        )[PhoneAccountLinkingViewModel::class.java]
