...
import com.vsphone.activities.assistant.fragments.CountryPickerFragment
...
abstract class AbstractPhoneViewModel(val accountCreator: AccountCreator) :
    ...
    fun isPhoneNumberOk(): Boolean {
        return countryName.value.orEmpty().isNotEmpty() && phoneNumber.value.orEmpty()
            .isNotEmpty() && phoneNumberError.value.orEmpty().isEmpty()
    }
