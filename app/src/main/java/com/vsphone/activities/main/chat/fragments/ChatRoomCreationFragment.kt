...
import com.vsphone.activities.main.chat.viewmodels.ChatRoomCreationViewModel
...
class ChatRoomCreationFragment : SecureFragment<ChatRoomCreationFragmentBinding>() {
    ...
    override fun onResume() {
        ...
        viewModel.secureChatAvailable.value = VSPhoneUtils.isEndToEndEncryptedChatAvailable()
    }
