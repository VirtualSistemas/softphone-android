 ...
 */
package com.vsphone.activities.main.dialer.fragments
...
import com.vsphone.activities.main.dialer.viewmodels.DialerViewModel
...
class DialerFragment : SecureFragment<DialerFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.setNewConferenceClickListener {
            sharedViewModel.updateDialerAnimationsBasedOnDestination.value =
                Event(R.id.conferenceSchedulingFragment)
