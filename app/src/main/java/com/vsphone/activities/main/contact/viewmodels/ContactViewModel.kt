 ...
 */
package com.vsphone.activities.main.contact.viewmodels
...
import com.vsphone.activities.main.contact.data.ContactNumberOrAddressClickListener
import com.vsphone.activities.main.contact.data.ContactNumberOrAddressData
import com.vsphone.activities.main.viewmodels.MessageNotifierViewModel
import com.vsphone.contact.ContactDataInterface
import com.vsphone.contact.ContactsUpdatedListenerStub
import com.vsphone.contact.hasPresence
...
class ContactViewModel(friend: Friend, async: Boolean = false) :
    ...
    private val listener = object : ContactNumberOrAddressClickListener {
        ...
        override fun onChat(address: Address, isSecured: Boolean) {
            ...
            val chatRoom = VSPhoneUtils.createOneToOneChatRoom(address, isSecured)
    ...
    fun updateNumbersAndAddresses() {
        ...
        for (address in friend.addresses) {
            ...
            val secureChatAllowed =
                VSPhoneUtils.isEndToEndEncryptedChatAvailable() && !isMe && friend.getPresenceModelForUriOrTel(
                    value
        ...
        for (phoneNumber in friend.phoneNumbersWithLabel) {
            ...
            val isMe =
                if (address != null) coreContext.core.defaultAccount?.params?.identityAddress?.weakEqual(
                    address
                ) ?: false else false
            val secureChatAllowed =
                VSPhoneUtils.isEndToEndEncryptedChatAvailable() && !isMe && friend.getPresenceModelForUriOrTel(
