 ...
 */
package com.vsphone.activities.main.files.adapters
...
class PdfPagesListAdapter(private val pdfViewModel: PdfFileViewModel) :
    RecyclerView.Adapter<PdfPagesListAdapter.PdfPageViewHolder>() {
