...
import com.vsphone.activities.main.chat.adapters.GroupInfoParticipantsAdapter
import com.vsphone.activities.main.chat.data.GroupInfoParticipantData
import com.vsphone.activities.main.chat.viewmodels.GroupInfoViewModel
import com.vsphone.activities.main.chat.viewmodels.GroupInfoViewModelFactory
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = GroupInfoParticipantsAdapter(
            ...
            chatRoom?.hasCapability(ChatRoomCapabilities.Encrypted.toInt())
                ?: (viewModel.isEncrypted.value == true)
        )
        ...
        binding.setParticipantsClickListener {
            sharedViewModel.createEncryptedChatRoom =
                corePreferences.forceEndToEndEncryptedChat || viewModel.isEncrypted.value == true
        ...
        binding.setLeaveClickListener {
            val dialogViewModel =
                DialogViewModel(getString(R.string.chat_room_group_info_leave_dialog_message))
