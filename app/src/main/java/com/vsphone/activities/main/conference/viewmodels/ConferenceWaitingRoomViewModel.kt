...
class ConferenceWaitingRoomViewModel : MessageNotifierViewModel() {
    ...
    init {
        ...
        audioRoutesMenuTranslateY.value =
            AppUtils.getDimension(R.dimen.voip_audio_routes_menu_translate_y)
        conferenceLayoutMenuTranslateY.value =
            AppUtils.getDimension(R.dimen.voip_audio_routes_menu_translate_y)
        ...
        callParams.isMicEnabled =
            PermissionHelper.get().hasRecordAudioPermission() && coreContext.core.isMicEnabled
        ...
        if (VSPhoneUtils.checkIfNetworkHasLowBandwidth(coreContext.context)) {
    ...
    fun toggleVideo() {
        ...
        callParams.isVideoEnabled = isVideoAvailableInCore()
        callParams.videoDirection =
            if (callParams.videoDirection == MediaDirection.SendRecv) MediaDirection.RecvOnly else MediaDirection.SendRecv
        updateVideoState()
    }
    ...
    private fun updateVideoState() {
        ...
        isVideoEnabled.value =
            callParams.isVideoEnabled && callParams.videoDirection == MediaDirection.SendRecv
        ...
        isSwitchCameraAvailable.value =
            callParams.isVideoEnabled && coreContext.showSwitchCameraButton()
