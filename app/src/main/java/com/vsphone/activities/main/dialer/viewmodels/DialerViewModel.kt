 ...
 */
package com.vsphone.activities.main.dialer.viewmodels
...
import com.vsphone.activities.main.dialer.NumpadDigitListener
import com.vsphone.activities.main.viewmodels.LogsUploadViewModel
...
class DialerViewModel : LogsUploadViewModel() {
    ...
    private val listener = object : CoreListenerStub() {
        ...
        override fun onAccountRegistrationStateChanged(
            ...
            scheduleConferenceAvailable.value = VSPhoneUtils.isRemoteConferencingAvailable()
        }
    }
    ...
    private fun setLastOutgoingCallAddress() {
        ...
        if (callLog != null) {
            enteredUri.value = VSPhoneUtils.getDisplayableAddress(callLog.remoteAddress)
        }
    }
}
