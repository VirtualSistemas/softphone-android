...
class CallLogsListViewModel : ViewModel() {
    ...
    init {
        ...
        showConferencesFilter.value = VSPhoneUtils.isRemoteConferencingAvailable()
    ...
    private fun computeCallLogs(
        ...
        for (callLog in callLogs) {
            if ((!missed && !conference) || (missed && VSPhoneUtils.isCallLogMissed(callLog)) || (conference && callLog.wasConference())) {
