 ...
 */
package com.vsphone.activities.main.chat.adapters
...
import com.vsphone.activities.main.chat.data.EventData
            ...
            with(binding) {
                if (eventLog.eventLog.type == EventLog.Type.ConferenceChatMessage) {
                    ...
                    setContextMenuClickListener {
                        ...
                        val itemSize =
                            AppUtils.getDimension(R.dimen.chat_message_popup_item_height).toInt()
