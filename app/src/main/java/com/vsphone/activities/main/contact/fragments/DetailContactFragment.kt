...
import com.vsphone.activities.main.contact.viewmodels.ContactViewModelFactory
...
class DetailContactFragment : GenericFragment<ContactDetailFragmentBinding>() {
    ...
    private fun sendSms(number: String) {
        ...
        val text =
            getString(R.string.contact_send_sms_invite_text).format(getString(R.string.contact_send_sms_invite_download_link))
