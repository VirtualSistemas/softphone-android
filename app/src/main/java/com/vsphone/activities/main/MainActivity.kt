 ...
 */
package com.vsphone.activities.main
...
import com.vsphone.activities.main.viewmodels.CallOverlayViewModel
import com.vsphone.activities.main.viewmodels.SharedMainViewModel
...
class MainActivity :
        ...
        when (intent.action) {
            Intent.ACTION_MAIN -> {
                ...
                if (call != null) {
                    ...
                    val callIntent =
                        Intent(this, com.vsphone.activities.voip.CallActivity::class.java)
    ...
    private fun handleTelOrSipUri(uri: Uri) {
        ...
        val address =
            coreContext.core.interpretUrl(addressToCall, VSPhoneUtils.applyInternationalPrefix())
        if (address != null) {
    ...
    private fun handleSendChatRoom(intent: Intent) {
        ...
        if (uri != null) {
            ...
            val peerAddress =
                coreContext.core.interpretUrl(addressToIM, VSPhoneUtils.applyInternationalPrefix())
                    ?.asStringUriOnly()
