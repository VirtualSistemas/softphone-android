 ...
 */
package com.vsphone.activities.voip.data
...
open class CallData(val call: Call) : GenericContactData(call.remoteAddress) {
    ...
    init {
        ...
        displayableAddress.value = VSPhoneUtils.getDisplayableAddress(call.remoteAddress)
    ...
    private fun updateConferenceInfo() {
        ...
        if (conference != null) {
            ...
            remoteConferenceSubject.value = VSPhoneUtils.getConferenceSubject(conference)
