...
import com.vsphone.contact.ContactLoader
import com.vsphone.contact.ContactsManager
import com.vsphone.contact.getContactForPhoneNumberOrAddress
...
class CoreContext(
    ...
    fun answerCall(call: Call) {
        ...
        params.recordFile = VSPhoneUtils.getRecordingFilePathForAddress(call.remoteAddress)

        if (VSPhoneUtils.checkIfNetworkHasLowBandwidth(context)) {
    ...
    fun transferCallTo(addressToCall: String): Boolean {
        ...
        if (currentCall == null) {
            ...
            val address = core.interpretUrl(addressToCall, VSPhoneUtils.applyInternationalPrefix())
            if (address != null) {
    ...
    fun startCall(to: String) {
        ...
        val address: Address? =
            core.interpretUrl(stringAddress, VSPhoneUtils.applyInternationalPrefix())
        if (address == null) {
    ...
    fun startCall(
        ...
        params.recordFile = VSPhoneUtils.getRecordingFilePathForAddress(address)
    ...
    private fun onIncomingReceived() {
        ...
        val intent = Intent(context, com.vsphone.activities.voip.CallActivity::class.java)
