        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                ...
                setPrimaryLeftMargin(
                    getDimension(
                        R.styleable.VoiceRecordProgressBar_primaryLeftMargin,
                        0f
                    )
                )
                setPrimaryRightMargin(
                    getDimension(
                        R.styleable.VoiceRecordProgressBar_primaryRightMargin,
                        0f
                    )
                )
