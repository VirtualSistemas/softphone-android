...
class ContactsManager(private val context: Context) {
    ...
    init {
        ...
        groupAvatar =
            IconCompat.createWithResource(context, R.drawable.voip_multiple_contacts_avatar_alt)
    ...
    fun updateLocalContacts() {
        ...
        for (account in coreContext.core.accountList) {
            ...
            friend.name = account.params.identityAddress?.displayName
    ...
    private fun initSyncAccount() {
        ...
        val accounts =
            accountManager.getAccountsByType(context.getString(R.string.sync_account_type))
        if (accounts.isEmpty()) {
