 ...
 */
package com.vsphone.compatibility
...
import com.vsphone.notifications.Notifiable
import com.vsphone.notifications.NotificationsManager
import com.vsphone.telecom.NativeCallWrapper
...
class Api26Compatibility {
    companion object {
        ...
        fun createIncomingCallNotification(
            ...
            val conferenceInfo =
                if (conferenceAddress != null) coreContext.core.findConferenceInformationFromUri(
                    conferenceAddress
                ) else null
            if (conferenceInfo == null) {
                ...
                displayName = contact?.name ?: VSPhoneUtils.getDisplayName(call.remoteAddress)
                address = VSPhoneUtils.getDisplayableAddress(call.remoteAddress)
                ...
                address = VSPhoneUtils.getDisplayableAddress(conferenceInfo.organizer)
        ...
        fun createCallNotification(
            ...
            val conferenceAddress = VSPhoneUtils.getConferenceAddress(call)
            val conferenceInfo =
                if (conferenceAddress != null) coreContext.core.findConferenceInformationFromUri(
                    conferenceAddress
                ) else null
            ...
            if (conferenceInfo == null) {
                ...
                val displayName = contact?.name ?: VSPhoneUtils.getDisplayName(call.remoteAddress)
